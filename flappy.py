...
# list of backgrounds
BACKGROUNDS_LIST = (
    'assets/sprites/background-front.jpg',
    'assets/sprites/background-lemonlime.jpg',
)

# list of pipes
PIPES_LIST = (
    'assets/sprites/pipe-green1.jpg',
    'assets/sprites/pipe-red1.png',
)
...
def main():
    ...
    # base (ground) sprite
    IMAGES['base'] = pygame.image.load('assets/sprites/base1.jpg').convert_alpha()
